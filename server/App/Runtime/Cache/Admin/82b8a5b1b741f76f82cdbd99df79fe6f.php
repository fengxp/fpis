...
<table width="100%">
	...
	<?php if(is_array($lists)): $i = 0; $__LIST__ = $lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr height="30">
			...
			<td>
				<a href="<?php echo U('Info/see',"id=$val[id]");?>">查看</a> |
				<a href="javascript:" onclick="return mydelete('<?php echo U('Info/delete_true',"id=$val[id]");?>');">彻底删除</a>
			</td>
