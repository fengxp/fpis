...
<meta charset="utf-8">
<link href="/lms/server/Public/jump/tip.css" rel="stylesheet" type="text/css">
</head> 
<body>
	<div class="errorbg"><img src="/lms/server/Public/jump/tip.jpg"></div>
	<div class="tu"><img src="<?php if(isset($message)): ?>/lms/server/Public/jump/success.png<?php else: ?>/lms/server/Public/jump/error.png<?php endif; ?>"><div class="msg" style="margin-top:15px"><?php if(isset($message)): echo($message); else: echo($error); endif; ?></div><div class="msg" style="color:#999999;font-size:12px"><span id="wait"><?php echo($waitSecond); ?></span>秒后自动跳转<a id="href" style="display:block; color:red" href="<?php echo($jumpUrl); ?>">点击手动跳转</a></div></div>
