...
<title>登录</title>
<link rel="stylesheet" href="/lms/server/Public/Admin/css/login.css">
...
var __PUBLIC = "/lms/server/Public";
$(function(){
	$('#code').keyup(function(){
		var code = $('#code').val();
...
<div class="main">
	<div class="login">
	<form name="loginform" id="loginform" method="post" action="<?php echo U('Login/index');?>" onSubmit="return check_login()">
	  <table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
	    <tr>
	      <td width="49%" rowspan="3"><p>看不清，点击图片刷新</p>
	      <div id="code_img">
	      <img style="border:1px solid #D4E7F6; cursor:pointer;" title="点我刷新哦！" src="<?php echo U('Login/verify');?>" onclick="javascript:this.src=this.src+'?time='+Math.random()" />
	      </div>
          </td>
	      <td width="12%">用户名：</td>
